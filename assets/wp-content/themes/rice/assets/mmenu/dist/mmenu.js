! function(e) {
    ...
    var S = function() {
            function e(t, n, i) {
                return this.opts = s(n, e.options), this.conf = s(i, e.configs), this._api = ["bind", "initPanels", "initPanel", "openPanel", "closePanel", "closeAllPanels", "setSelected"], this.node = {}, this.vars = {}, this.hook = {}, this.clck = [], this.node.menu = "string" == typeof t ? document.querySelector(t) : t, "function" == typeof this._deprecatedWarnings && this._deprecatedWarnings(), this._initWrappers(), this._initAddons(), this._initExtensions(), this._initHooks(), this._initAPI(), this._initMenu(), this._initPanels(), this._initOpened(), this._initAnchors(),
                    function() {
                        var e = function(e) {
            ...
            return e.prototype.openPanel = function(e, t) {
                ...
                var t = this;
                this.trigger("initPanels:deprecated"), (e = e || _(this.node.pnls)).forEach(function(e) {
                    t.initPanel(e)
                })
                ...
                e.id = t, e.classList.add("mm-panel"), e.classList.add("mm-hidden");
                var a = [e.parentElement].filter(function(e) {
                    return e.matches("li")
                })[0];
                return n ? a && a.classList.add("mm-listitem_vertical") : this.node.pnls.append(e), a && (a.mmChild = e, e.mmParent = a), this._initNavbar(e), this._initListview(e), this.trigger("initPanel:after", [e]), e
            }, e.prototype._initNavbar = function(e) {
                if (this.trigger("initNavbar:before", [e]), !_(e, ".mm-navbar").length) {
                    var t = null,
                        n = null;
                    if (e.dataset.mmParent ? n = g(this.node.pnls, e.dataset.mmParent)[0] : (t = e.mmParent) && (n = t.closest(".mm-panel")), (!t || !t.matches(".mm-listitem_vertical")) && (n || this.opts.navbar.title)) {
                ...
                var t = this;
                this.trigger("initListview:before", [e]), _(e, "ul, ol").forEach(function(e) {
                    E(e, t.conf.classNames.nolistview, "mm-nolistview"), e.matches(".mm-nolistview") || (e.classList.add("mm-listview"), _(e).forEach(function(e) {
                        e.classList.add("mm-listitem"), E(e, t.conf.classNames.selected, "mm-listitem_selected"), E(e, t.conf.classNames.spacer, "mm-listitem_spacer"), _(e, "a, span").forEach(function(e) {
                ...
                if (n && n.matches(".mm-listitem") && !_(n, ".mm-btn").length) {
                    ...
                    if (i) {
                        ...
                        a.setAttribute("href", "#" + e.id), i.matches("span") ? (a.classList.add("mm-listitem__text"), a.innerHTML = i.innerHTML, n.insertBefore(a, i.nextElementSibling), i.remove()) : n.insertBefore(a, _(n, ".mm-panel")[0])
                    }
                }
            ...
            }, e.version = "8.3.0", e.options = i, e.configs = a, e.addons = {}, e.wrappers = {}, e.node = {}, e.vars = {}, e
        }(),
        M = {
            blockUI: !0,
            moveBackground: !0
    ...
    f({
        ...
        cancel: "annuleren"
    }, "nl"), f(Ee, "fa"), f(xe, "de"), f(Pe, "ru"), S.options.searchfield = Le, S.configs.searchfield = we;
    var ke = function() {
            var e = this.opts.searchfield,
                t = (this.conf.searchfield, _(this.node.pnls, ".mm-panel_search")[0]);
            if (t) return t;
            var n = b("ul.mm-listview");
            switch ((t = b("div.mm-panel_search")).append(n), this.node.pnls.append(t), e.panel.id && (t.id = e.panel.id), e.panel.title && (t.dataset.mmTitle = e.panel.title), e.panel.fx) {
                case !1:
                    break;
                case "none":
    ...
    S.addons = {
            ...
            this.opts.dividers = s(t, S.options.dividers), this.bind("initListview:after", function(t) {
                ...
                e.matches(t.addTo) && (g(e, ".mm-divider").forEach(function(e) {
                    ...
                    L(_(e)).forEach(function(n) {
                        var i = _(n, ".mm-listitem__text")[0].textContent.trim().toLowerCase()[0];
                        if (i.length && i != t) {
                            t = i;
        ...
        iconbar: function() {
            ...
            if (this.opts.iconbar = s(n, S.options.iconbar), n.use && (["top", "bottom"].forEach(function(t, i) {
                ...
                if ("boolean" == typeof n.use ? this.bind("initMenu:after", a) : P(n.use, a, function() {
