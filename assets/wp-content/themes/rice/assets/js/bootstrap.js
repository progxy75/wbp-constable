! function(t, e) {
    ...
    var A = "carousel",
        ...
        Y = function() {
            ...
            return n.next = function() {
                ...
                if (t === L ? (i = x, o = K, s = R) : (i = U, o = q, s = j), h && e(h).hasClass(W)) this._isSliding = !1;
        ...
        kt = function() {
            ...
            return i.toggle = function() {
                ...
                if (!n || 3 !== n.which && ("keyup" !== n.type || 9 === n.which))
                    for (var i = [].slice.call(document.querySelectorAll(vt)), o = 0, s = i.length; o < s; o++) {
    ...
    var Ie = "scrollspy",
        ...
        je = function() {
            ...
            return n.refresh = function() {
                ...
                i.hasClass(Oe) ? (i.closest(Le.DROPDOWN).find(Le.DROPDOWN_TOGGLE).addClass(ke), i.addClass(ke)) : (i.addClass(ke), i.parents(Le.NAV_LIST_GROUP).prev(Le.NAV_LINKS + ", " + Le.LIST_ITEMS).addClass(ke), i.parents(Le.NAV_LIST_GROUP).prev(Le.NAV_ITEMS).children(Le.NAV_LINKS).addClass(ke)), e(this._scrollElement).trigger(Ne.ACTIVATE, {
                    relatedTarget: t
                })
            }, n._clear = function() {
        ...
        ze = function() {
            ...
            return n.show = function() {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && e(this._element).hasClass(Fe) || e(this._element).hasClass(Ue))) {
                    var n, i, o = e(this._element).closest(Ve)[0],
                        s = c.getSelectorFromElement(this._element);
                    if (o) {
                        var r = "UL" === o.nodeName || "OL" === o.nodeName ? Be : Qe;
                        i = (i = e.makeArray(e(o).find(r)))[i.length - 1]
                    }
                    var a = e.Event(Me.HIDE, {
                            relatedTarget: this._element
                        }),
                        l = e.Event(Me.SHOW, {
                            relatedTarget: i
                ...
                var o = this,
                    s = (!n || "UL" !== n.nodeName && "OL" !== n.nodeName ? e(n).children(Qe) : e(n).find(Be))[0],
    ...
    e.fn.toast = an._jQueryInterface, e.fn.toast.Constructor = an, e.fn.toast.noConflict = function() {
        ...
        }(), t.Util = c, t.Alert = g, t.Button = D, t.Carousel = Y, t.Collapse = rt, t.Dropdown = kt, t.Modal = qt, t.Popover = Se, t.Scrollspy = je, t.Tab = ze, t.Toast = an, t.Tooltip = de, Object.defineProperty(t, "__esModule", {
            value: !0
        })
});